...
<nav class="navbar navbar-expand-lg navbar-light">
    ...
    <div class="navbar-collapse collapse" id="navbarSupportedContent">
	  ...
	  <a href="../index.php"><button type="button" class="btn btn-dark ml-3" style="float:left;position:relative;top:3rem;left:4rem;">HOME</button></a>		
	<div class="text-center pt-5">
		<h1 class="info" style="background-color:white; color:black;">ACCOUNT INFORMATION</h1>
	</div>
