  ...
  <?php if (empty($products)): ?>
    ...
    <?php else: ?>  
        ...
        <div class="buttons" style="float:right;">
            ...
            <a href="index.php?page=checkout"><input type="button" class="btn btn-dark" value="Place Order" name="placeorder" style="margin-top:.5rem; font-family:'Montserrat';position:relative;left:2rem;
    margin-right:.5rem;
